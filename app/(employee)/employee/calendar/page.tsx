...
interface CalEvent {
  ...
  title: string;
  date: string;
  type: "Holiday" | "Company" | "Leave" | "Review" | "Training";
}

const EVENTS: CalEvent[] = [
  { id: 1, title: "All Hands Meeting", date: "2026-09-03", type: "Company" },
  { id: 2, title: "Labor Day (Holiday)", date: "2026-09-02", type: "Holiday" },
  { id: 3, title: "Maria Santos — Annual Leave", date: "2026-09-01", type: "Leave" },
  { id: 4, title: "Maria Santos — Annual Leave", date: "2026-09-02", type: "Leave" },
...
const typeColors: Record<string, string> = {
  Holiday: "bg-rose-100 border-rose-300 text-rose-700",
  Company: "bg-purple-100 border-purple-300 text-purple-700",
  Leave: "bg-amber-100 border-amber-300 text-amber-700",
  Review: "bg-sky-100 border-sky-300 text-sky-700",
  Training: "bg-emerald-100 border-emerald-300 text-emerald-700",
};
...
const typeVariant: Record<string, "default" | "danger" | "success" | "warning" | "info" | "secondary"> = {
  Holiday: "danger",
  Company: "default",
  Leave: "warning",
  Review: "info",
...
export default function EmployeeCalendarPage() {
  ...
  const handleAddEvent = (ev: React.FormEvent) => {
    ...
    const newEv: CalEvent = { id: Date.now(), title: newTitle, date: newDate, type: newType };
